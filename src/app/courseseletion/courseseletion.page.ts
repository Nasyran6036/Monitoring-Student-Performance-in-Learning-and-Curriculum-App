...
import { Post } from '../studentperformance/models/post.mode';
...
export class CourseseletionPage implements OnInit {
  ...
  async getPostById(){
    ...
    this.firestore.doc("StudentInfo/" + this.uid)
    .valueChanges()
    .subscribe(data => {
    ...
    this.firestore.doc("5 CEMERLANG" + '/' + this.uid + '/' + "FirstExam" + '/' + this.uid )
    .valueChanges()
    .subscribe(data => {
    ...
    this.firestore.doc("5 CERDIK" + '/' + this.uid + '/' + "FirstExam" + '/' + this.uid )
    .valueChanges()
    .subscribe(data => {
      this.posts.BM1 = data["BM1"];
      this.posts.BI1 = data["BI1"];
    ...
    this.firestore.doc("5 CERDAS" + '/' + this.uid + '/' + "FirstExam" + '/' + this.uid )
    .valueChanges()
    .subscribe(data => {
      this.posts.BM1 = data["BM1"];
      this.posts.BI1 = data["BI1"];
    ...
    this.firestore.doc("5 CEKAP" + '/' + this.uid + '/' + "FirstExam" + '/' + this.uid )
    .valueChanges()
    .subscribe(data => {
      this.posts.BM1 = data["BM1"];
      this.posts.BI1 = data["BI1"];
    ...
    this.firestore.doc("5 CEMERLANG" + '/' + this.uid + '/' + "MidExam" + '/' + this.uid )
    .valueChanges()
    .subscribe(data => {
    ...
    this.firestore.doc("5 CERDIK" + '/' + this.uid + '/' + "MidExam" + '/' + this.uid )
    .valueChanges()
    .subscribe(data => {
      this.posts.BM2 = data["BM2"];
      this.posts.BI2 = data["BI2"];
    ...
    this.firestore.doc("5 CERDAS" + '/' + this.uid + '/' + "MidExam" + '/' + this.uid )
    .valueChanges()
    .subscribe(data => {
      this.posts.BM2 = data["BM2"];
      this.posts.BI2 = data["BI2"];
    ...
    this.firestore.doc("5 CEKAP" + '/' + this.uid + '/' + "MidExam" + '/' + this.uid )
    .valueChanges()
    .subscribe(data => {
      this.posts.BM2 = data["BM2"];
      this.posts.BI2 = data["BI2"];
    ...
    this.firestore.doc("5 CEMERLANG" + '/' + this.uid + '/' + "FinalExam" + '/' + this.uid )
    .valueChanges()
    .subscribe(data => {
    ...
    this.firestore.doc("5 CERDIK" + '/' + this.uid + '/' + "FinalExam" + '/' + this.uid )
    .valueChanges()
    .subscribe(data => {
      this.posts.BM3 = data["BM3"];
      this.posts.BI3 = data["BI3"];
    ...
    this.firestore.doc("5 CERDAS" + '/' + this.uid + '/' + "FinalExam" + '/' + this.uid )
    .valueChanges()
    .subscribe(data => {
      this.posts.BM3 = data["BM3"];
      this.posts.BI3 = data["BI3"];
    ...
    this.firestore.doc("5 CEKAP" + '/' + this.uid + '/' + "FinalExam" + '/' + this.uid )
    .valueChanges()
    .subscribe(data => {
      this.posts.BM3 = data["BM3"];
      this.posts.BI3 = data["BI3"];
    ...
    this.firestore.doc("5 CEMERLANG" + '/' + this.uid + '/' + "curriculum" + '/' + this.uid )
    .valueChanges()
    .subscribe(data => {
    ...
    this.firestore.doc("5 CERDIK" + '/' + this.uid + '/' + "curriculum" + '/' + this.uid )
    .valueChanges()
    .subscribe(data => {
      this.posts.kelabsukan = data["kelabsukan"];
      this.posts.jawatankelabsukan = data["jawatankelabsukan"];
    ...
    this.firestore.doc("5 CERDAS" + '/' + this.uid + '/' + "curriculum" + '/' + this.uid )
    .valueChanges()
    .subscribe(data => {
      this.posts.kelabsukan = data["kelabsukan"];
      this.posts.jawatankelabsukan = data["jawatankelabsukan"];
    ...
    this.firestore.doc("5 CEKAP" + '/' + this.uid + '/' + "curriculum" + '/' + this.uid )
    .valueChanges()
    .subscribe(data => {
      this.posts.kelabsukan = data["kelabsukan"];
      this.posts.jawatankelabsukan = data["jawatankelabsukan"];
