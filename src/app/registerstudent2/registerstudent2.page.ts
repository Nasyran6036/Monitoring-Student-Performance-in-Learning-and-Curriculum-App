...
@Component({
  selector: 'app-registerstudent2',
  templateUrl: './registerstudent2.page.html',
  styleUrls: ['./registerstudent2.page.scss'],
})
export class Registerstudent2Page implements OnInit {
  user = {} as User;
    ...
    if(this.formValidation()){
      ...
      try{
        ...
        .then(data =>
          ...
          this.afStore.collection("5CERDIK").doc((await this.afAuth.currentUser).uid).set(user);
